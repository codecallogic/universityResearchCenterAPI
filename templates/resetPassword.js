                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style="padding: 13px 17px; border-radius: 8px; background-color: #1f72eb" bgcolor="#1f72eb" valign="top" align="center">
                                                    <a href="${process.env.CLIENT_URL}/auth/reset/${token}" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;">Reset Password</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
