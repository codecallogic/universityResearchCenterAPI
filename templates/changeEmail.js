exports.changeEmailTemplate = (oldEmail, newEmail, token) => {
  return {
                                ...
                                <tr>
                                  <td class="pc-sm-p-35-30 pc-xs-p-25-20" style="padding: 40px; background-color: #ffffff; border-radius: 8px;" valign="top" bgcolor="#ffffff">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                      ...
                                      <tbody>
                                        <tr>
                                          <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 20px; font-weight: 300; line-height: 28px; color: #1B1B1B; letter-spacing: -0.2px;" valign="top" align="center">We received a request to change the e-mail associated with your ARCLAMS account from ${oldEmail} to ${newEmail}. If this is correct, please confirm your new e-mail address by visiting:</td>
                                        </tr>
                                        <tr>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style="padding: 13px 17px; border-radius: 8px; background-color: #1f72eb" bgcolor="#1f72eb" valign="top" align="center">
                                                    <a href="${process.env.CLIENT_URL}/auth/email/${token}" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;">Confirm Email Change</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 300; line-height: 28px; color: #9B9B9B; text-align: center;" valign="top">If you didn't request this, you don't need to do anything; you won't receive any more email's from us.. This link expires in 24 hours after the original request.<br><br>If you did NOT request to change your email, do not click on the button.&nbsp;<br><br>Sincerely, <br><br>ARCLAMS Team</td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
